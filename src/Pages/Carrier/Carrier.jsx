            ...
            <div className="carrier_layer3_main">
                ...
                <div className="carrier_layer3_part2_outer">
                    <div className="layer3_part2_nav_bar">
                        <p onClick={() => handleNav("All")} className={`part2_nav_items ${activeNav === "All" ? "layer3_active" : ""}`}>
                            ALL
                        </p>
                        <p onClick={() => handleNav("Our")} className={`part2_nav_items ${activeNav === "Our" ? "layer3_active" : ""}`}>
                            Our
                        </p>
                        <p onClick={() => handleNav("Clients")} className={`part2_nav_items ${activeNav === 'Clients' ? "layer3_active" : ""}`}>
                            Clients
                        </p>
                    </div>
